...
param sqlServerName = 'poc-bicep-poc-sqlserver1'
param sqlDatabaseName = 'poc-bicep-poc-sqldatabase'
...
param storageAccountName = 'poc-storageaccount'
param logAnalyticsWorkspace = 'poc-loganalytics'
